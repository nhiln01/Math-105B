function AdaptiveQuadrature_NhiNguyen(a1,b1,tol,f,n)
APP = 0; %Step 1
i = 1;
TOL = zeros(1,n);
a = zeros(1,n);
...
fprintf('The Adaptive quadrature integration is %2.8f\n',APP) %Step 6 % Get the approximation within tolerance
end